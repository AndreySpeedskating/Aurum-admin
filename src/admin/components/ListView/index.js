...
function ListView({
  ...
  const { post, del, put } = fetchClient;
  ...
  const bulkUpdateMutation = useMutation(
    (data) =>
    axios.post(`/api/bulk/${contentType.uid}/update`, data, { headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer `,
      }}),
    {
      onSuccess() {
        toggleNotification({
          type: 'success',
          message: {
            id: 'content-manager.success.record.update',
            defaultMessage: 'Unpublished',
          },
        });
  ...
  const handleConfirmUpdate = (selectedEntries) => {
    return bulkUpdateMutation.mutateAsync({ ids: selectedEntries, attribute: 'approved', value: true });
  };
            ...
            <Table.Root rows={data} isLoading={isLoading} colCount={colCount}>
              <Table.ActionBar>
                <BulkActionButtons
                  ...
                  showUpdate={canDelete && contentType.uid === 'api::application.application'}
