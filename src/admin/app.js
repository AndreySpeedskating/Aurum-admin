...
const config = {
  ...
  translations: {
    ru: {
      ...
      UnloadingPoint: 'Пункты разгрузки',
      LoadingPoint: 'Пункты погрузки',
      Counterpartie: 'Контрагенты',
      COUNTERPARTIES: 'Контрагенты',
      counterparties: 'Контрагенты',
      USERS_PERMISSIONS_USER: 'Водитель',
      users_permissions_user: 'Водитель',
      Cargo: 'Грузы',
      true: 'Да',
      false: 'Нет',
      ...
      publishedAt: 'Состояние',
      name: 'Имя',
      Reports: 'Отчеты',
      auto_park: 'Гаражный номер',
      avaliable: 'Подтверждение',
      id: 'Ид',
      GarageNumber: 'Гаражный номер',
      ApplicationPhoto: 'Фото заявки',
      ...
      ApplicationDate: 'Дата накладной',
      ApplicationNumber: 'Номер накладной',
      counterpartie: 'Контрагент',
      volume: 'Объем',
      approved: 'Подтверждена',
      geolink: 'Координаты отправки',
      weight: 'Вес',
      cargos: 'Грузы',
      loading_time: 'Время погрузки',
      unloading_time: 'Время разгрузки',
      cargo: 'Груз',
      LoadingPoints: 'Пункты погрузки',
      UnloadingPoints: 'Пункты разгрузки',
      loading_points: 'Пункты погрузки',
      unloading_points: 'Пункты разгрузки',
      loading_point: 'Пункт погрузки',
      unloading_point: 'Пункт разгрузки',
      alt_loading_points: 'Альт. Пункты погрузки',
      alt_unloading_points: 'Альт. Пункты разгрузки',
      alt_loading_point: 'Альт. Пункт погрузки',
      alt_unloading_point: 'Альт. Пункт разгрузки',
      milleage: 'Пробег с грузом км.',
      ...
      'Roles.RoleRow.user-count':
        '{number, plural, =0 {# пользователей} one {# пользователь} other {# пользователей}}',
      ...
      'Settings.application.customization.auth-logo.carousel-hint':
        'Замените логотип на странице авторизации',
      ...
      'Settings.review-workflows.page.subtitle':
        '{count, plural, =0 {# этапов} one {# этап} other {# этапа}}',
      ...
      'Settings.webhooks.to.delete':
        '{webhooksToDeleteLength, plural, =0 {# ассетов} one {# ассет} other {# ассеты}} выбраны',
      ...
      'admin.pages.MarketPlacePage.filters.categoriesSelected':
        'Выбрано {count, plural, =0 {# категорий} one {# категория} other {# категории}}',
      'admin.pages.MarketPlacePage.filters.collections': 'Коллекции',
      'admin.pages.MarketPlacePage.filters.collectionsSelected':
        'Выбрано {count, plural, =0 {# Коллекций} one {# Коллекция} other {# Коллекции}}',
      ...
      'app.components.LeftMenu.documents': 'Документы',
      'app.components.LeftMenu.dictionaries': 'Справочники',
      ...
      'app.components.LeftMenu.reports': 'Отчеты',
      ...
      'app.components.LeftMenuLinkContainer.reports': 'Отчеты',
      ...
      'components.popUpWarning.update.message': 'Вы уверены, что хотите обновить записи?',
      ...
      'content-manager.components.DynamicZone.missing-components':
        '{number, plural, =0 {# отсутствующих компонентов} one {# отсутствующий компонент} other {# отсутствующих компонентов}}',
      ...
      'content-manager.containers.ListPage.items':
        '{number, plural, =0 {элементов} one {элемент} other {элементы}}',
      'content-manager.containers.ListPage.table-headers.publishedAt': 'Состояние',
      'content-manager.containers.ListPage.table-headers.name': 'Имя',
      'content-manager.containers.ListPage.table-headers.auto_park': 'Гаражный номер',
      'content-manager.containers.ListPage.table-headers.avaliable': 'Подтверждение',
      'content-manager.containers.ListPage.table-headers.id': 'Ид',
      'content-manager.containers.ListPage.table-headers.GarageNumber': 'Гаражный номер',
      'content-manager.containers.ListPage.table-headers.ApplicationPhoto': 'Фото заявки',
      'content-manager.containers.ListPage.table-headers.SendDate': 'Дата отправки',
      'content-manager.containers.ListPage.table-headers.StateNumber': 'Гос. Номер',
      'content-manager.containers.ListPage.table-headers.Driver': 'Водитель',
      'content-manager.containers.ListPage.table-headers.driver': 'Водитель',
      'content-manager.containers.ListPage.table-headers.BrandModel': 'Марка/Модель',
      'content-manager.containers.ListPage.table-headers.createdAt': 'Дата создания',
      'content-manager.containers.ListPage.table-headers.counterparties': 'Контрагенты',
      'content-manager.containers.ListPage.table-headers.updatedAt': 'Дата обновления',
      'content-manager.containers.ListPage.table-headers.username': 'Имя пользователя',
      'content-manager.containers.ListPage.table-headers.phone': 'Телефон',
      'content-manager.containers.ListPage.table-headers.DriverName': 'Имя водителя',
      'content-manager.containers.ListPage.table-headers.blocked': 'Блокировка',
      'content-manager.containers.ListPage.table-headers.DeliveryDate': 'Дата доставки',
      'content-manager.containers.ListPage.table-headers.ApplicationDate': 'Дата накладной',
      'content-manager.containers.ListPage.table-headers.ApplicationNumber': 'Номер накладной',
      'content-manager.containers.ListPage.table-headers.counterpartie': 'Контрагент',
      'content-manager.containers.ListPage.table-headers.users_permissions_user': 'Водитель',
      'content-manager.containers.ListPage.table-headers.volume': 'Объем м3',
      'content-manager.containers.ListPage.table-headers.approved': 'Подтверждена',
      'content-manager.containers.ListPage.table-headers.geolink': 'Координаты отправки',
      'content-manager.containers.ListPage.table-headers.weight': 'Вес т.',
      'content-manager.containers.ListPage.table-headers.cargos': 'Грузы',
      'content-manager.containers.ListPage.table-headers.LoadingPoints': 'Пункты погрузки',
      'content-manager.containers.ListPage.table-headers.UnloadingPoints': 'Пункты разгрузки',
      'content-manager.containers.ListPage.table-headers.loading_points': 'Пункты погрузки',
      'content-manager.containers.ListPage.table-headers.unloading_points': 'Пункты разгрузки',
      'content-manager.containers.ListPage.table-headers.loading_point': 'Пункт погрузки',
      'content-manager.containers.ListPage.table-headers.unloading_point': 'Пункт разгрузки',
      'content-manager.containers.ListPage.table-headers.alt_loading_points':
        'Альт. Пункты погрузки',
      'content-manager.containers.ListPage.table-headers.alt_unloading_points':
        'Альт. Пункты разгрузки',
      'content-manager.containers.ListPage.table-headers.alt_loading_point': 'Альт. Пункт погрузки',
      'content-manager.containers.ListPage.table-headers.milleage': 'Пробег с грузом км.',
      'content-manager.containers.ListPage.table-headers.alt_unloading_point':
        'Альт. Пункт разгрузки',
      'content-manager.containers.ListPage.table-headers.CompanyName': 'Наименование компании',
      'content-manager.containers.ListPage.table-headers.confirmed': 'Подтверждение',
      'content-manager.containers.ListPage.table-headers.loading_time': 'Время погрузки',
      'content-manager.containers.ListPage.table-headers.unloading_time': 'Время разгрузки',
      'content-manager.containers.ListPage.table-headers.role': 'Роль',
      'content-manager.containers.ListPage.table-headers.cargo': 'Груз',
      'content-manager.containers.ListPage.table-headers.phone': 'Телефон',
      'content-manager.containers.ListPage.table-headers.secret': 'Секретный ключь',
      'content-manager.containers.ListPage.table-headers.active': 'Активный',
      'content-manager.containers.ListPage.table-headers.createdBy': 'Кем создано',
      'content-manager.containers.ListPage.table-headers.updatedBy': 'Кем обновлено',
      'content-manager.containers.ListPage.table-headers.password': 'Пароль',
      'content-manager.containers.ListPage.table-headers.AppVersion': 'Версия приложения',
      ...
      'content-manager.form.Input.hint.character.unit':
        '{maxValue, plural, one { символ} other { символов}}',
      ...
      'content-manager.popUpwarning.warning.has-draft-relations.message':
        '<b>{count, plural, =0 {отношений записей} one {отношение записей} other {отношений записей}}</b> ещё не опубликованы.<br></br>Это может привести к появлению неработающих ссылок и ошибок в вашем проекте.',
      'content-manager.popover.display-relations.label': 'Показать отношения',
      'content-manager.relation.add': ' ',
      ...
      'content-manager.success.record.update': 'Обновлено',
      ...
      'content-manager.utils.data-loaded':
        '{number, plural, =0 {записей} one {запись} other {записей}} успешно загружено',
      dark: 'Тёмная',
      'form.button.continue': 'Продолжить',
      'form.button.done': 'Выполнено',
      'global.confirmed': 'Подтвердить',
      ...
      submit: 'Отправить',
      'cell.value.boolean.true': 'да',
      'cell.value.boolean.false': 'нет',
      'cell.value.geolocation': 'Координаты',
    },
  },
  tutorials: false,
  notifications: {
